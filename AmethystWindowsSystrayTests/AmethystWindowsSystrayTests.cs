...
namespace AmethystWindowsSystrayTests
{
    ...
    public class AmethystWindowsSystrayTests
    {
        ...
        public void GridGeneratorCountOne()
        {
            ...
            IEnumerable<Tuple<int, int, int, int>> gridGenerator = desktopWindowsManager.GridGenerator(1000, 1000, 1, 0, layout);
        ...
        {
            layout = Layout.Horizontal;
            IEnumerable<Tuple<int, int, int, int>> gridGenerator = desktopWindowsManager.GridGenerator(1000, 1000, 2, 0, layout);
        ...
        {
            layout = Layout.Horizontal;
            IEnumerable<Tuple<int, int, int, int>> gridGenerator = desktopWindowsManager.GridGenerator(1000, 1000, 3, 0, layout);
        ...
        {
            layout = Layout.Horizontal;
            IEnumerable<Tuple<int, int, int, int>> gridGenerator = desktopWindowsManager.GridGenerator(1000, 1000, 4, 0, layout);
        ...
        {
            layout = Layout.Horizontal;
            IEnumerable<Tuple<int, int, int, int>> gridGenerator = desktopWindowsManager.GridGenerator(1000, 1000, 5, 0, layout);
        ...
        {
            layout = Layout.VertGrid;
            IEnumerable<Tuple<int, int, int, int>> gridGenerator = desktopWindowsManager.GridGenerator(1000, 1000, 6, 0, layout);
